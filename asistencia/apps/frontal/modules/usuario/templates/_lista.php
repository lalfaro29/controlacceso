...
<script type="text/javascript">
    listado_empleado = $('#listado_empleados').dataTable( {
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": "<?php echo url_for('@usuario_lista') ; ?>",
...
<?php if(!isset($funcion)): ?>             
    function empleado_seleccionar(id,nombre,apellido,cedula,te,cargo,dpto,sueldo,sede,fecha,proyecto,configuracion,ip,tipoUsuario,idusuario){
