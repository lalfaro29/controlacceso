...
/**
 * JefeUnidad filter form base class.
 *
 * @package    asistencia
 * @subpackage filter
 ...
 */
abstract class BaseJefeUnidadFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('jefe_unidad_filters[%s]');
